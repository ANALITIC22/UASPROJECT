 ...
 *      para registro relacional. El registro dinámico ocurre en
 *      supabase.js → saveRecords() → _upsertCliente().
 ...
 *      para que supabase.js lo convierta a ISO string para TIMESTAMPTZ.
...
const Parser = (() => {
  ...
  /**
   * REQ B: Convierte string ISO o Date a marcador de Timestamp para supabase.js.
   * El objeto { _isTs:true, iso } será interceptado en saveRecords() y
   * convertido a ISO string para TIMESTAMPTZ.
   */
  ...
  /**
    ...
    * El registro dinámico del cliente se
    * delega a supabase.js para no hacer round-trips aquí.
   */
