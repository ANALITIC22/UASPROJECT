 ...
 *
 * La deduplicación en Firestore (server-side) es garantizada por
 * firebase.js mediante batch.set(ref, data, { merge: true }) con
 * IDs determinísticos generados por parser.js.
 */
